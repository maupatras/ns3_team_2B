...
To υποσύστημα ιχνηλασίας είναι ένας από τους πιο σημαντικούς μηχανισμούς για να κατανοήσει κάποιος στον |ns3|. Στις περισσότερες περιπτώσεις, οι χρήστες του |ns3| θα έχουν μια λαμπρή ιδέα για κάποια νέα και βελτιωμένη δυνατότητα δικτύωσης. Για να επιβεβαιώσουμε ότι αυτή η ιδέα δουλεύει, ο ερευνητής θα κάνει κάποιες αλλαγές στο υπάρχων σύστημα και έπειτα θα κάνει πειράματα για να δει πως το νέο χαρακτηριστικό συμπεριφέρεται με τη συλλογή στατιστικών στοιχείων που αποτυπώνουν τη συμπεριφορά του χαρακτηριστικού. 
